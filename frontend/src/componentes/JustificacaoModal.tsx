...
export function JustificacaoModal({ open, onClose, onSave, defaultDate }: JustificacaoModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-lg mx-4 bg-surface shadow-modal rounded-xl p-5 animate-in fade-in zoom-in duration-200">
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full h-10 px-3 rounded-lg bg-elevated/50 text-sm text-primary outline-none focus:bg-elevated/80 transition-all duration-200"
              />
            </div>
            <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full h-10 px-3 rounded-lg bg-elevated/50 text-sm text-primary outline-none focus:bg-elevated/80 transition-all duration-200 appearance-none"
            >
          ...
          {motivo === "Atestado médico" && (
            <div className="flex flex-col gap-1.5">
              ...
              <button
                ...
                className="flex items-center gap-3 w-full h-10 px-3 rounded-lg bg-elevated/50 text-sm text-secondary hover:text-primary hover:bg-elevated/80 transition-all duration-200"
              >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 rounded-lg bg-elevated/50 text-sm text-primary placeholder-[#64748B] outline-none focus:bg-elevated/80 transition-all duration-200 resize-none"
            />
          </div>
        </div>
