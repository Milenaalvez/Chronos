        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 rounded-lg bg-elevated text-sm text-primary placeholder-[#64748B] outline-none focus:bg-elevated/80 transition-all duration-200 resize-none"
            />
          </div>
        </div>
