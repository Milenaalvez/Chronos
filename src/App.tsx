...
export default function App() {
  ...
  const [user, setUser] = useState<{ id: string; name: string; email: string; role: string; position?: string | null; avatar?: string | null; companyId?: string; hireDate?: string; permissions?: string[]; emailVerified?: boolean; themeMode?: string; themeAccent?: string } | null>(null)
  ...
  return (
    ...
    <div className="h-screen bg-app text-primary">
      ...
      <main className="lg:ml-72 h-screen px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 overflow-y-auto">
        {/* Mobile hamburger */}
        <button
