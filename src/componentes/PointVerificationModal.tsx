        ...
        <div className="relative w-full max-w-md mx-4 bg-surface border border-white/10 rounded-xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
          <div className="p-6 text-center">
            ...
            <button
              ...
              disabled={confirming}
              className="h-11 px-8 rounded-xl bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-primary)]/80 text-sm font-bold text-white flex items-center gap-2 mx-auto hover:brightness-110 disabled:opacity-40 transition-all shadow-[0_0_20px_-5px_var(--accent-primary)]"
            >
              {confirming ? (
          ...
          <button
            ...
            className={`w-full h-12 rounded-xl text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 ${
              password && captchaVerified
                ? "bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-primary)]/80 text-white hover:brightness-110 active:scale-[0.98] shadow-[0_0_20px_-5px_var(--accent-primary)]"
